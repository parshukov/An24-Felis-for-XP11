...
if vers_year >= 2012 then set(sim_version, 11) end
...
--QFE
createProp("parshukovedition/mmhg", "float", 0);
createProp("parshukovedition/inchhg", "float", 0);
...
--		},
	    ...
	    gns430stuff {position = { 898, 4, 294, 165 } },	
------------------------------- Из Як-40 Фелис, автор Н. Паршуков ------------------------------------
