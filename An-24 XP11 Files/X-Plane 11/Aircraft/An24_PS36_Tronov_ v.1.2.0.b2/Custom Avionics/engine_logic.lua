...
-- table of throttles
local tro_table = {{ 0.00,  0.041 },    -- IDLE
                  {  0.12,  0.178 },    -- 0.2 nom  -  420 hp
                  {  0.22,  0.34  },    -- 0.4 nom  -  840 hp
                  {  0.34,  0.505 },    -- 0.6 nom  -  1260 hp
                  {  0.41,  0.585 },    -- 0.7 nom  -  1470 hp
                  {  0.52,  0.705 },    -- 0.85 nom -  1785 hp
           	      {  0.65,  0.83  },    -- nominal  -  2100 hp
          	      {  1.00,  1.000 }}    -- takeoff  -  2550 hp
          	      
-- tables for altitude correction --variant
